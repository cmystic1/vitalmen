        ...
        <section className="relative w-full min-h-[600px] lg:min-h-[85vh] overflow-hidden bg-[#111111]">
            <div className="flex flex-col lg:flex-row min-h-[600px] lg:min-h-[85vh]">
                ...
                <div className="relative w-full lg:w-1/2 h-[380px] lg:h-auto overflow-hidden">
                    <img
                        src="https://a.storyblok.com/f/273742/1200x800/bd99d494bf/bt_heroimage_aw_1200x800_1.png/m/1600x1280/filters:focal(725x503:726x504)/"
                    ...
                    <div className="max-w-[540px] w-full space-y-7">
                        <div className="space-y-2">
                            ...
                            <p className="text-[18px] text-[#f4f4f4]/80 font-medium mt-3">
                                Take a simple, at-home blood test, target key health areas, treat your deficiencies, and track your progress - all in one place.
                            </p>
                        </div>

                        <div className="flex items-baseline gap-2 text-white">
                            <span className="text-[18px] font-normal">From</span>
                            <span className="text-[28px] font-extrabold text-[#00cfc1]"><span style={{textDecoration: 'line-through', fontSize: '18px', fontWeight: 'normal'}}>$68.00&nbsp;</span>&nbsp;$47.60</span>
                            <span className="text-[18px] font-normal">/ kit</span>
                        </div>
