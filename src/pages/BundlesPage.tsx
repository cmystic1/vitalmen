...
const BUNDLE_IDS = ['ed-testosterone-combo', 'complete-mens-health', 'over-50s-pack']

const BundlesPage = () => {
  const bundleProducts = products.filter((p) => BUNDLE_IDS.includes(p.id))
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="mb-12">
            ...
            <h2 className="text-[32px] md:text-[38px] font-semibold text-black mb-3 max-w-2xl">
              Complete packages for men's health
            </h2>
            <p className="text-[17px] text-[#4a4a4a]">
              All bundles are prescribed by UK-registered doctors and delivered discreetly to your door.
            </p>
          </div>
