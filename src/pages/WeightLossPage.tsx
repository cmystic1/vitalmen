...
import Hero from '../components/sections/WeightLossPageHero'
...
const WEIGHT_LOSS_IDS = ['semaglutide', 'orlistat']

const WeightLossPage = () => {
  const weightLossProducts = products.filter((p) => WEIGHT_LOSS_IDS.includes(p.id))
        ...
        <div className="max-w-[1280px] mx-auto">
          <div className="mb-12">
            ...
            <h2 className="text-[32px] md:text-[38px] font-semibold text-black mb-3 max-w-2xl">
              Clinically proven weight loss solutions
            </h2>
